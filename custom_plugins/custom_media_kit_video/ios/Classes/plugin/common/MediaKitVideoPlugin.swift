...
public class MediaKitVideoPlugin: NSObject, FlutterPlugin {
  ...
  public func handle(
    ...
    case "VideoOutputManager.Create":
      self.handleCreateMethodCall(call.arguments, result)
    case "VideoOutputManager.SetSize":
      self.handleSetSizeMethodCall(call.arguments, result)
    case "VideoOutputManager.Dispose":
      self.handleDisposeMethodCall(call.arguments, result)
    case "Utils.EnterNativeFullscreen":
      self.handleEnterNativeFullscreenMethodCall(call.arguments, result)
    case "Utils.ExitNativeFullscreen":
      self.handleExitNativeFullscreenMethodCall(call.arguments, result)
    default:
